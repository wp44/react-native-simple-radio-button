...
var { Text, View, TouchableOpacity, TouchableWithoutFeedback } = ReactNative;
...
export default class RadioForm extends React.Component {
  ...
  isIndexSelected = i => {
    const selectedIndex = this.props.radio_props.findIndex(
  ...
  _renderButton(obj, i) {
    return (
      <RadioButton
        ...
        isSelected={this.isIndexSelected(i)}
        obj={obj}
        key={i}
        index={i}
        buttonColor={
          this.isIndexSelected(i)
        ...
        wrapStyle={this.props.itemStyle}
        buttonWrapStyle={this.props.buttonWrapStyle}
      />
    );
  }
